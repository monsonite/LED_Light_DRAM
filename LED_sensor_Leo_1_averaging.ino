...
acc_pulsetime = 0;      // Reset the accumulator

for (int i = 0 ; i<=average ; i++)      // Average samples into pulsetime accumulator
...
acc_pulsetime = acc_pulsetime + pulsetime ;  //  Average into accumulator
...
Serial.println(acc_pulsetime/average);
